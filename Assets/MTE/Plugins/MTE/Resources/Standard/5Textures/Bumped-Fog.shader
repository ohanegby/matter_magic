Shader "MTE/Standard/5 Textures/Bumped/Fog"
{
	...
	CGINCLUDE
		...
		void MTE_SplatmapMix(Input IN, half4 defaultAlpha, out half4 splat_control, out half4 splat_control_extra, out half weight, out fixed4 mixedDiffuse, inout fixed3 mixedNormal)
		{
